...
namespace aekulib
{
     ...
     */
    template <typename Key, typename Value> class interpolating_map
    {
      public:
        /**
         ...
         */
        void insert(const Key &key, const Value &value) { m_container.insert(std::pair{key, value}); }
         ...
         * @param value The value.
         */
        void insert(Key &&key, Value &&value) { m_container.insert(std::pair{key, value}); }
